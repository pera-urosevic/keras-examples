...
early_stopping = callbacks.EarlyStopping(monitor="loss", min_delta=0.01, patience=5, verbose=1)

train_x, train_y = get_train_data()
history = model.fit(train_x, train_y, epochs=50, batch_size=32, callbacks=[tensorboard, early_stopping])
